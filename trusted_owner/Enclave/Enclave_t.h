...
int ecall_deploy_vm(sev_certs_t certs, measurement_info_t measurement_info, sev_session_buf* out_session_data_buf, sev_cert* out_godh_pubkey_cert);
int ecall_provision_vm(uint8_t hmac_measurement[32], nonce_128* mnonce, sev_hdr_buf* out_packaged_secret_header, uint8_t out_encrypted_blob[64], measurement_info_t* measurement_info);
int ecall_generate_report_for_vm(uint8_t vm_data[64], hmac_sha_256* vm_data_hmac, sgx_target_info_t* qe_target_info, sgx_report_t* out_sgx_report);
